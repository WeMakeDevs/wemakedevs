			...
			<div className="max-w-6xl mx-auto px-4">
				<div className="text-center mb-16">
					...
					<p className="text-lg text-gray-600 max-w-2xl mx-auto">
						Compete for amazing prizes and showcase your
				...
				<div className="grid grid-cols-1 gap-8">
					...
					<div className="relative rounded-2xl shadow-xl p-8 text-white overflow-hidden bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 group hover:shadow-2xl transition-all duration-300">
							...
							<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
								...
								<div className="bg-white/95 text-gray-900 rounded-xl p-5 shadow-md">
									<div className="flex items-center justify-between mb-2">
										...
										<div className="flex items-center gap-1 text-blue-600 opacity-90">
											<Trophy className="w-4 h-4" />
										</div>
									</div>
								...
								<div className="bg-white/90 text-gray-900 rounded-xl p-5 shadow-md">
									<div className="flex items-center justify-between mb-2">
										...
										<div className="flex items-center gap-1 text-blue-600 opacity-80">
											<Trophy className="w-4 h-4" />
										</div>
									</div>
					...
					{/* Community Rewards */}
					<div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl border-2 border-blue-200 shadow-lg p-8 h-full flex flex-col">
						<div className="flex items-center gap-4 mb-6">
						...
						<div className="flex-grow">
							<p className="text-gray-700 leading-relaxed mb-4">
								...
								). Top 10 posts will win Lingo credits and swag
								bundles.
							</p>
							<div className="flex items-center gap-2 bg-white/60 rounded-lg px-4 py-2 w-fit border border-blue-200">
