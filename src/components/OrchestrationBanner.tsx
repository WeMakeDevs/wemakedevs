...
const CORAL_SUBMISSION_URL = "https://forms.gle/iLRYXPsGHFTj7xaeA";
		...
		>
			...
			<p className="flex-1 text-sm md:text-base text-slate-200 font-medium font-title truncate">
				<span className="hidden sm:inline">
					📜 Coral Hackathon submissions are open! Submit by May 31,
					23:59 IST.
				</span>
				<span className="sm:hidden">
					📜 Coral submissions open, deliver your treasure!
				</span>
			</p>

			{/* CTA */}
			<Link
				href={CORAL_SUBMISSION_URL}
				target="_blank"
