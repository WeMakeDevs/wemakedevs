...
export const alt = "Cline × WeMakeDevs — Hackathon Proposal";
		...
		>
			...
			<div style={{ display: "flex", flexDirection: "column", gap: 26 }}>
				...
				>
					...
					>
						Cline in front of 5,000+ builders
					</span>
					.
				</div>
			</div>
			...
			>
				{[
					...
					["3,000+", "Cline Platform Signups"],
					["1.6M+", "Livestream Reach"],
				].map(([num, label]) => (
					<div
						key={label}
