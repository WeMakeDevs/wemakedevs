...
// Try to derive a friendly label for a blog post URL: prefer the slug or a
...
// Friendly label for a PR/issue URL: "owner/repo · #123".
		...
		<div className="pt-20 pb-16 min-h-screen">
			...
			<ViewContainer id="prs" className="mt-12 scroll-mt-32">
				...
				<p className="text-[#93a1a1] text-sm md:text-base mb-6">
					Pirates who built source specs and sent pull requests
					straight to the{" "}
					<a
			...
			<ViewContainer id="all-projects" className="mt-16 scroll-mt-32">
				<div className="flex items-center gap-3 mb-2 flex-wrap">
