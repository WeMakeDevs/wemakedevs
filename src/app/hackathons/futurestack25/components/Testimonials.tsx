...
import { futurestackTestimonials } from "../testimonials";

const FutureStackTestimonials = ({ className, ...props }: GeneralComponent) => {
	return (
		<section
			...
			<ViewContainer className="">
				...
				>
					<CarouselContent className="h-[520px]">
						{futurestackTestimonials.map((item, index) => (
							<CarouselItem
								key={item.name}
...
export default FutureStackTestimonials;
