...
import { lingohackTestimonials } from "../testimonials";

const LingohackTestimonials = ({ className, ...props }: GeneralComponent) => {
	return (
		<section
			...
			<ViewContainer>
				...
				>
					<CarouselContent className="h-[520px]">
						{lingohackTestimonials.map((item, index) => (
							<CarouselItem
								key={item.name}
...
export default LingohackTestimonials;
