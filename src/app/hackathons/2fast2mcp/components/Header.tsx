			...
			<ViewContainer className="relative z-10">
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
					...
					<div className="col-span-1 lg:col-span-2">
						...
						{cta.disabled ? (
							<span className="inline-flex items-center gap-2 bg-slate-500/20 text-slate-400 px-4 py-1.5 rounded-full text-sm md:text-base font-semibold border border-slate-500/30 cursor-not-allowed">
								Submissions closed
							</span>
						) : (
							<Link
