			...
			{numbers.map((item, index) => {
				...
				return (
					<div
						key={item.name}
						className={cn(
							"group bg-slate-900/80 backdrop-blur-sm shadow-[0_15px_35px_rgba(0,0,0,0.45)] border border-orange-500/20 rounded-xl p-5 pb-4 relative overflow-clip hover:border-orange-400/40 transition-colors",
						)}
					>
						<div
							className={cn(
						...
						/>
						<Icon className="opacity-80 z-10 text-orange-400" size={28} />
...
export default TwoFastTwoMcpStats;
