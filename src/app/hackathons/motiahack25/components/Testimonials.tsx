...
import { motiahackTestimonials } from "../testimonials";

const MotiaTestimonials = ({ className, ...props }: GeneralComponent) => {
	return (
		<section
			className={cn(className, "mt-6 pb-10 scroll-m-[100px] bg-[#050705]")}
			{...props}
			id="testimonials"
		>
			<ViewContainer>
				...
				>
					<CarouselContent className="h-[520px]">
						{motiahackTestimonials.map((item, index) => (
							<CarouselItem
								key={item.name}
...
export default MotiaTestimonials;
