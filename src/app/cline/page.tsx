	...
	return (
		<div className="prospects">
			<div className="slide-stage">
				...
				{/* SLIDE 10: AI Agents Assemble (Cline featured) */}
				<section className={isActive(9)}>
					...
					<span className="event-tag">
						AI Agents Assemble × Cline (featured partner)
					</span>
					<h2 className="event-title">
						AI Agents{" "}
					...
					<div className="event-body" style={{ alignItems: "start" }}>
						<div className="event-stats">
							...
							<div className="ev-stat featured">
								...
								<div className="label">
									Cline Platform Signups
								</div>
							</div>
							<div className="ev-stat">
								<div className="num">Online</div>
								<div className="label">
									Global · Fully managed by WMD
								</div>
							</div>
							<div className="ev-stat">
								<div className="num">
								...
								<div className="label">
									Livestream Reach · Kunal&apos;s channels
								</div>
							</div>
						</div>
						<div className="pack" style={{ marginTop: 0 }}>
							...
							<ul>
								<li>
									Incredible projects built on Cline, based on
									our track record
								</li>
								<li>
									3,000+ signups to the Cline platform from
									participants
								</li>
								<li>
									Builders writing blogs about Cline and
									sharing on socials
								</li>
								<li>
									Livestream on Kunal&apos;s channels (1.6M+
									combined reach)
								</li>
								<li>
								...
								<li>
									WeMakeDevs manages everything, end to end
								</li>
							</ul>
						</div>
					</div>
				...
				<section className={isActive(15)}>
					<div className="strip">
						<div className="brand">
							<span>05 /</span> Investment
						</div>
						<div className="meta">One package · Online</div>
					</div>
					<div className="eyebrow">Investment</div>
					<h2 className="title" style={{ marginBottom: "1.25rem" }}>
						One package.{" "}
						<span className="grad">Everything included.</span>
					</h2>
					<div className="value-banner">
						...
						<div className="value-copy">
							<div className="value-headline">
								devs trying Cline &amp; giving real feedback
							</div>
							<div className="value-sub">
								Plus 3,000+ Cline platform signups, builder
								blogs, social buzz, and a livestream to 1.6M+
								across Kunal&apos;s channels, all managed end to
								end.
							</div>
						</div>
					</div>
					...
					>
						<div className="price-card featured">
							...
							<ul className="price-list">
								...
								<li>3,000+ signups to the Cline platform</li>
								<li>
									Builder blogs &amp; social posts about Cline
								</li>
								<li>
									Livestream on Kunal&apos;s channels · 1.6M+
									reach
				...
				<section className={`${isActive(16)} cta`}>
					...
					>
						Let&apos;s put Cline in builders&apos; hands
					</div>
					<h1 className="display">
					...
					<p className="cta-sub">
						Reach out and we&apos;ll scope the hackathon, plan the
						goals, and start building with the Cline team.
					</p>
