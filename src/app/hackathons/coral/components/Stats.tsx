			...
			{numbers.map((item, index) => {
				...
				return (
					<div
						key={item.name}
						className={cn(
							"group bg-[#0c1a2e]/80 backdrop-blur-sm shadow-[0_15px_35px_rgba(0,0,0,0.45)] border border-amber-500/20 rounded-xl p-5 pb-4 relative overflow-clip hover:border-amber-400/40 transition-colors",
						)}
					>
						<div
							className={cn(
