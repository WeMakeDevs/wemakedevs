...
import { JSX, ClassAttributes, HTMLAttributes, OlHTMLAttributes, LiHTMLAttributes, AnchorHTMLAttributes } from "react";
...
const components = {
  ...
  li: (props: JSX.IntrinsicAttributes & ClassAttributes<HTMLLIElement> & LiHTMLAttributes<HTMLLIElement>) => (
