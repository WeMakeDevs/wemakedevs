				...
				{groupedSchedule.map((group, index) => (
					<button
						...
						className={cn(
							...
							"focus:outline-none",
							selectedDate === index
								? "bg-gradient-to-r from-amber-500 to-yellow-500 text-slate-900 hover:from-amber-400 hover:to-yellow-400"
						...
						return (
							...
							>
								...
								<div className="rounded-full p-1.5 bg-amber-500/50 shadow-lg shadow-amber-500/30 relative z-10">
									<div className="rounded-full bg-gradient-to-br from-amber-400 to-yellow-500 shadow-md h-5 w-5" />
								</div>
								...
								{isTextItem ? (
									...
									<div className="px-4 py-2 ring-2 ring-amber-500/20 w-full hover:ring-amber-500/40 transition-all bg-slate-800/50 rounded-lg">
