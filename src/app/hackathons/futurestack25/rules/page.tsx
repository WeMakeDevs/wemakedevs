			...
			<ViewContainer className="my-10">
				<HackathonContentBody>
					<ol className="list-decimal list-outside space-y-4 pl-6">
						<li>
							Using at least one sponsor technology (Cerebras,
							Meta Llama, or Docker) is mandatory to be eligible
							to win cash prizes and interview opportunities.
							Teams not using any sponsor technology will not
							qualify for these prizes.
						</li>
						<li>
